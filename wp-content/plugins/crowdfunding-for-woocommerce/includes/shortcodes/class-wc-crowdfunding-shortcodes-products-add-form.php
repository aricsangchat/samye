...
class Alg_WC_Crowdfunding_Products_Add_Form_Shortcodes {
	 ...
	 * @version 2.3.0
	 * @since   2.3.0
	 * @todo    [dev] refill image on not validated (or after successful addition)?; more messages options; more styling options; custom fields; variable products; user selection of product type (simple, variable, open pricing);
	 */

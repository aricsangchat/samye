...
class GFTWOCHECKOUTData{

    public static function update_table(){
        global $wpdb;

        $table_name = self::get_twocheckout_table_name();
    ...
    public static function get_twocheckout_table_name(){
        global $wpdb;

        return $wpdb->prefix . "rg_twocheckout";
    }

    public static function get_transaction_table_name(){
        global $wpdb;

        return $wpdb->prefix . "rg_twocheckout_transaction";
    }
    ...
    public static function get_feed_by_form($form_id, $only_active = false){
        ...
        return apply_filters("gform_twocheckout_get_feeds_{$form_id}", apply_filters('gform_twocheckout_get_feeds', $results, $form_id), $form_id);
    }
    ...
    public static function drop_tables(){
        ...
        $wpdb->query("DROP TABLE IF EXISTS " . self::get_twocheckout_table_name());
    }

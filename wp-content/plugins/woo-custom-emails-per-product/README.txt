...
For WooCustomEmails version 2+, you can use any HTML allowed in the WYSIWYG editor.
...
1. New Admin menu: "Custom Emails"
2. 'Woo Custom Email Message' example content - full WYSIWYG editor for each message!
3. New Tab in the WooCommerce Product Data section: "Custom Emails"
4. Use the search fields to find your WCE Messages, then assign one to each Order Status. Click the Title of your Message to assign it, then Update/Publish the Product to keep these settings.
5. Custom Message example content inserted into the default WooCommerce customer receipt email
6. Woo Custom Emails Settings page
...
Fix: "After Order Meta" and "After Customer Details" settings have been updated so the content will appear where it is expected to be inside the email.
...
= 2.0.0 =
New version 2.0 released! Now includes a new Custom Post Type for Custom Email Messages, moves the Woo Product Data options into their own Tab, and fixes the issue where duplicate messages are displayed in emails.

= 2.2.0 =
New version 2.2.0 released! Now on each Product, you can assign a Custom Message for all 3 Order Status emails: "On-hold", "Processing", and "Completed".

...
class Woo_Product_Data_Admin {
	...
	?>
		...
		jQuery(document).ready( function($) {
			...
			// Focus/Click on Search Field Shows Search Results Box
			$(document).on('focus click','.wce-product-options-table .wcemessage_search_field_input', function(e) {

				// Hide all search results elements
				$('.wcemessage_search_results').addClass('hidden');

				// Show closest search results element
				$(this).closest('.message').find('.wcemessage_search_results').removeClass('hidden');

			});

			// Blur/Click off Search Field Hides Search Results Box
			$(document).on('focus click','.wce-product-options-table .order_status, .wce-product-options-table .location', function(e) {

				// Apply class to closest search results element
				$(this).closest('.table-row').find('.wcemessage_search_results').addClass('hidden');

			});

			// Remove button
			$(document).on('click','.wce-product-options-table .remove-wcemessage', function(e) {
			...
			// Assign WCE Message
	        $(document).on('click','.wce-product-options-table .wce-search-result', function(e) {
				...
				// Update field values
				$(this).closest('.table-row').find('.wcemessage_search_field_hidden').val(theid);	// hidden field
				$(this).closest('.table-row').find('.wcemessage_search_field_input').val(thetitle);	// search field

				// Add a new 'Remove' button if not already present
				$(this).closest('.table-row').find('.button-container:not(.remove)').addClass('remove').html('<a href="#" class="button remove-wcemessage" alt="Remove" title="Remove"><span class="dashicons dashicons-no"></span></a>');

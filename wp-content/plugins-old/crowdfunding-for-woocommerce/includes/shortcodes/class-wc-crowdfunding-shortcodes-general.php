...
class Alg_WC_Crowdfunding_Shortcodes_General extends Alg_WC_Crowdfunding_Shortcodes {
	...
	function alg_product_crowdfunding_goal_items_remaining( $atts ) {
		...
		return $this->output_shortcode( intval( get_post_meta( $product_id, '_' . 'alg_crowdfunding_goal_items', true ) ) - alg_get_product_orders_data( 'total_items', $atts ), $atts );
	}
	...
	function alg_product_crowdfunding_goal_backers_remaining( $atts ) {
		...
		return $this->output_shortcode( intval( get_post_meta( $product_id, '_' . 'alg_crowdfunding_goal_backers', true ) ) - alg_get_product_orders_data( 'total_orders', $atts ), $atts );
	}
	...
	function alg_product_crowdfunding_goal_remaining( $atts ) {
		...
		return $this->output_shortcode( floatval( get_post_meta( $product_id, '_' . 'alg_crowdfunding_goal_sum', true ) ) - alg_get_product_orders_data( 'orders_sum', $atts ), $atts );
	}

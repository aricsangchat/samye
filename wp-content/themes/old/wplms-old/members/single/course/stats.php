	...
	if(is_array($certificates)){
		if(in_array($course->ID,$certificates)){ 
			$url = bp_get_course_certificate('user_id='.$user_id.'&course_id='.$course->ID);
          	...
          	echo '<a href="'.$url.'" class="ajax-certificate '.$class.'" data-user="'.$user_id.'" data-course="'.$course->ID.'" data-security="'.wp_create_nonce($user_id).'"><span><i class="icon-certificate-file"></i></span></a>';
		}
	}
}

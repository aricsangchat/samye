...
$custom_curriculum = get_post_meta( $id, 'sen_custom_curriculum', true );

if( !empty( $custom_curriculum ) && trim( $custom_curriculum ) !== '' ) {

	echo '<div class="custom-curriculum">';
	echo apply_filters( 'the_content', $custom_curriculum );
	echo '</div>';
